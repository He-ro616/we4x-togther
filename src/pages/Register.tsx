...
export default function Register() {
  ...
  }, [user, authLoading, navigate, getDefaultRoute]);
  ...
  const onSubmit = async (data: RegisterForm) => {
    ...
    if (error) {
      ...
      toast.success('Welcome to we4x! Check your email to confirm your account.');
    }
  };
      ...
      <div className="w-full max-w-md space-y-6">
        ...
        <Card className="gradient-border">
          <CardHeader className="text-center">
            ...
            <CardTitle className="font-display text-2xl">Join we4x</CardTitle>
